    ...
    ui(new Ui::DBCNodeRebaseEditor)
{
    ...
    connect(ui->btnDoRebase, &QPushButton::pressed,
        [=]()
        {
            ...
            {
                QMessageBox::question(this, "No Valid Messages", "The node has no valid messages to change.", QMessageBox::StandardButtons(QMessageBox::Ok));
                return;
            }
            ...
            {
                QMessageBox::question(this, "No Messages", "The node has no messages to change.", QMessageBox::StandardButtons(QMessageBox::Ok));
                return;
            }

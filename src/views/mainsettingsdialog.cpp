...
static QStringList availableLanguageCodes()
{
    ...
    QRegularExpression re(QStringLiteral("SavvyCAN_(.*)\\.(qm|ts)"));
    ...
    ui(new Ui::MainSettingsDialog)
{
    ...
    connect(ui->comboTheme, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &MainSettingsDialog::updateSettings);
    connect(ui->cbDisplayHex, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbFlowAutoRef, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbFlowUseTimestamp, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbInfoAutoExpand, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbMainAutoScroll, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbPlaybackLoop, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbRestorePositions, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbValidate, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->spinPlaybackSpeed, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainSettingsDialog::updateSettings);
    connect(ui->rbSeconds, &QRadioButton::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->rbMicros, &QRadioButton::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->rbSysClock, &QRadioButton::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->rbMillis, &QRadioButton::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbCSVAbsTime, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->comboSendingBus, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &MainSettingsDialog::updateSettings);
    connect(ui->cbUseFiltered, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->lineClockFormat, &QLineEdit::editingFinished, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbUseOpenGL, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->lineRemoteHost, &QLineEdit::editingFinished, this, &MainSettingsDialog::updateSettings);
    connect(ui->lineRemotePort, &QLineEdit::editingFinished, this, &MainSettingsDialog::updateSettings);
    connect(ui->lineRemoteUser, &QLineEdit::editingFinished, this, &MainSettingsDialog::updateSettings);
    connect(ui->lineRemotePassword, &QLineEdit::editingFinished, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbLoadConnections, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbFilterLabeling, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbHexGraphFlow, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbHexGraphInfo, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->cbIgnoreDBCColors, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->spinMaximumFrames, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainSettingsDialog::updateSettings);
    connect(ui->cbFontFixedWidth, &QCheckBox::toggled, this, &MainSettingsDialog::updateSettings);
    connect(ui->spinBytesPerLine, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainSettingsDialog::updateSettings);
